...
export function AdminIcon({ size = 24, className }: IconProps) {
  return (
    <svg {...base(size, className)} strokeWidth={0.01} fill="currentColor">
...
export function ConnectionIcon({ size = 24, className }: IconProps) {
  return (
    <svg {...base(size, className)} viewBox="0 0 346.311 346.311" fill="currentColor">
  <g>
    <g>
